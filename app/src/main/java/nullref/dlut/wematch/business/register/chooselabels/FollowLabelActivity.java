...
public class FollowLabelActivity extends BaseActivity implements FollowLabelActivityContract.View {


    FollowLabelActivityContract.Presenter presenter = new FollowLabelPresenter(this);
