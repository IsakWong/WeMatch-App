...
public class ModifyInformationActivity extends BaseActivity<ModifyInformationContract.Presenter> implements ModifyInformationContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != bundle) {
            ...
            Glide
                    .with(ModifyInformationActivity.this)
                    .asBitmap()
                    .load(avatarUrlPath)
                    .apply(options2)
            ...
            case REQUEST_CODE_PICK_IMAGE:
                if (res == RESULT_OK) {
                    try {
                        ...
                        Bitmap outBitmap = Utils.blurBitmap(ModifyInformationActivity.this, bit, 20f);
